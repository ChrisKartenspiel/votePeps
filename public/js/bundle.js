...
var CharacterActions = function () {
  ...
  _createClass(CharacterActions, [{
    ...
    value: function report(characterId) {
      ...
      $.ajax({ type: 'POST', url: '/api/report', data: { characterId: characterId } }).done(function () {
...
var HomeActions = function () {
  function HomeActions() {
    ...
    this.generateActions('getTwoCharactersSuccess', 'getTopCharactersFail', 'voteFail');
  }
  ...
  _createClass(HomeActions, [{
    ...
    value: function vote(winner, loser) {
      ...
      $.ajax({
        ...
        _this2.actions.voteDail(jqXhr.responseJSON.message);
      });
    }
  }]);
  ...
  _createClass(CharacterList, [{
    ...
    value: function render() {
      var charactersList = this.state.characters.map(function (character, index) {
        return _react2.default.createElement(
          'div',
          { key: character.char | acterId, className: 'list-group-item animated fadeIn' },
          _react2.default.createElement(
            'div',
            { className: 'media' },
            _react2.default.createElement(
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function handleClick(character) {
      ...
      var loser = loser = (0, _underscore.first)((0, _underscore.without)(this.state.characters, (0, _underscore.findWhere)(this.state.characters, { characterId: winner }))).characterId;
    ...
    value: function handleSubmit(event) {
      ...
      if (searchQuery) {
        _NavbarActions2.default.findCharacter({
          ...
          searchFrom: this.refs.searchFrom,
...
var CharacterStore = function () {
  ...
  _createClass(CharacterStore, [{
    ...
    value: function onGetCharacterSuccess(data) {
      ...
      var localData = localStorage.getItem('votePeps') ? JSON.parse(localStorage.getItem('votePeps')) : {};
    ...
    value: function onReportSuccess(data) {
      ...
      localStorage.setItem('votePeps', JSON.stringify(localData));
...
var HomeStore = function () {
  ...
  _createClass(HomeStore, [{
    ...
    value: function onGetTwoCharactersFail(erroMessage) {
